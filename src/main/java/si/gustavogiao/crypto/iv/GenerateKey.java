...
public class GenerateKey {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            System.out.println("Usage: java -cp target/classes si.gustavogiao.crypto.iv.GenerateKey <keyfile> <algorithm> <size>");
            System.out.println("Example: java -cp target/classes si.gustavogiao.crypto.iv.GenerateKey <keyfile> <algorithm> <size>");
            return;
        }
